...
class DashboardServiceTest {
    ...
    void t1() {
        ...
        SubscriptionEvaluation eval1 = new SubscriptionEvaluation(netflix, targetMonth);
        ...
        ReflectionTestUtils.setField(eval1, "costPerUnit", 1000L);

        SubscriptionEvaluation eval2 = new SubscriptionEvaluation(chatgpt, targetMonth);
        ...
        ReflectionTestUtils.setField(eval2, "costPerUnit", 967L);

        given(evaluationRepository.findAllWithSubscriptionAndCategoryByEvalMonth(targetMonth))
        ...
        assertThat(s1.costPerUnit()).isEqualTo(1000L);
        ...
        assertThat(s2.costPerUnit()).isEqualTo(967L);
    }
    ...
    void t3() {
        ...
        SubscriptionEvaluation eval = new SubscriptionEvaluation(netflixTrial, targetMonth);
        ReflectionTestUtils.setField(eval, "efficiencyRate", 50.0);
        ReflectionTestUtils.setField(eval, "status", EvaluationStatus.REVIEW);
        ReflectionTestUtils.setField(eval, "annualWaste", 0L);        // TRIAL 정책
        ReflectionTestUtils.setField(eval, "costPerUnit", 500L);
        ...
        // costPerUnit 전달 확인
        assertThat(s.costPerUnit()).isEqualTo(500L);
    }
    ...
    void t4() {
        ...
        SubscriptionEvaluation eval = new SubscriptionEvaluation(trial, targetMonth);
        ...
        ReflectionTestUtils.setField(eval, "costPerUnit", 1234L);
        ...
        // costPerUnit 전달 확인
        assertThat(s.costPerUnit()).isEqualTo(1234L);
    }
}
